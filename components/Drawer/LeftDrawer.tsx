                  ...
                  >
                    <div className="flex flex-col py-60px pb-40px lg:pb-60px">
                      <a
                        ...
                        href="https://medsy-modern.vercel.app/"
                      >
                        Medsy Modern
                      </a>
                      <a
                        className="relative pr-4 mb-8 font-semibold text-gray-900 transition duration-300 ease-in-out menu-item pl-30px last:mb-0 hover:text-gray-900 active"
                        href="#"
                      >
                        Medsy Minimal
                      </a>
