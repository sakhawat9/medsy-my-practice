    ...
    return (
        <div className="flex items-center justify-center w-full px-4 bg-white shadow-footer py-30px lg:px-35px lg:justify-between">
            ...
            <div className="items-center hidden lg:flex">
                <a href="https://www.facebook.com/sakhawat.hossain.338211" className="social facebook" target="_blank">
                ...
                <a href="https://github.com/SakhawatHossain55" className="social github" target="_blank">
                ...
                <a href="https://www.linkedin.com/in/sakhawat-hossain-95a57b203/" className="social instagram" target="_blank">
                ...
                <a href="https://www.linkedin.com/in/sakhawat-hossain-95a57b203" className="social linkedin" target="_blank">
